...
export default function MagazineDetailPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Hero Image */}
      <div className="w-full max-h-[400px] overflow-hidden mt-16">
        <img
          src={article.image}
          alt={article.title}
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-4 py-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight mb-8">
          {article.title}
        </h1>
